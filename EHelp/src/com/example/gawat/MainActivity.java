...
public class MainActivity extends Activity implements OnItemSelectedListener {
	...
	// Textview
	TextView rs_alamat, rs_notelp, tvDetail,jumlah2;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Animation animAlpha = AnimationUtils.loadAnimation(this,
				R.anim.anim_alpha);
		final Animation animAlpha1 = AnimationUtils.loadAnimation(this,
				R.anim.anim_alpha);
		...
		btnNotif.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				arg0.startAnimation(animAlpha1);
		...
		animAlpha1.setAnimationListener(animationListenerNotif);
	...
	AnimationListener animationListenerNotif = new AnimationListener() {
		...
		public void onAnimationEnd(Animation animation) {
	        ...
	        alertDialog.setTitle("Konfirmasi Penjemputan...");
	 
	        // Setting Dialog Message
	        alertDialog.setMessage("Apakah Anda Sudah Dijemput ?");
	        ...
	        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
	            ...
	            Toast.makeText(getApplicationContext(), "Anda Sudah Dijemput", Toast.LENGTH_SHORT).show();
	        ...
	        alertDialog.setNegativeButton("NO", new DialogInterface.OnClickListener() {
	            ...
	            Toast.makeText(getApplicationContext(), "Anda Belum Dijemput", Toast.LENGTH_SHORT).show();
	            dialog.cancel();
	            }
	        });
			...
			public void onClick(View view) {
				if (validasi() == true) {
					...
					for (int i = 0; i <= namaRS.length - 1; i++) {
						if (spinner_namaRS.getSelectedItem().toString()
								.equals(namaRS[i])) {
							notelp = teleponRS[i];
							alamat = alamatRS[i];
...
//							MainActivity.this,
//							"nama: "
//									+ spinner_namaRS.getSelectedItem()
//											.toString() + ",telp: " + notelp
//									+ ",alamat: " + alamat, Toast.LENGTH_LONG)
//							.show();
					...
					try {
						...
						if (mailsender.send()) {
							...
							db.InsertRegister(spinner_namaRS.getSelectedItem()
									.toString(), random, idpeg, notelp, alamat,
									jlh_ambu.getText().toString(), "Available");
							dialog.dismiss();
//							Toast.makeText(getApplicationContext(), "" + idpeg,
//									Toast.LENGTH_LONG).show();
							...
							RESTClient.get()
									.register(
											spinner_namaRS.getSelectedItem()
													.toString(), random,
											idpeg.toString(), notelp, alamat,
											jlh_ambu.getText().toString(),
											"Available",
											new Callback<String>() {
												@Override
												public void failure(
							...
							Log.e("random dan id", spinner_namaRS
